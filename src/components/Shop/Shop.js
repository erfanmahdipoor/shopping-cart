...
export default class Shop extends Component {
    ...
    constructor(props) {
        ...
        this.emptyShoppingCard =this.emptyShoppingCard.bind(this)
        this.removeProductFromCard =this.removeProductFromCard.bind(this)
    ...
    this.setState(prevState =>{ return {shoppingCart:[...prevState.shoppingCart ,mainProduct]}})
    }
    emptyShoppingCard(){
        this.setState({
            shoppingCart:[]
   ...
   console.log(productId);
   let newShoppingCard = this.state.shoppingCart.map(product=> product.id !== productId)
   this.setState({shoppingCart:newShoppingCard})
   }
                ...
                <section class="container content-section">
                    <div class="shop-items">
                         {this.state.products.map((product)=>{
                             return  <Product onAddProduct={this.addProductToCart} key={product.id}  {...product}/>
                         })}
                    </div>
                </section>
                <section class="container content-section">
                    ...
                    <div class="cart-items">

                       {
                        this.state.shoppingCart.map((product)=> 
                                  <CartProduct key={product.id} {...product} remove={this.removeProductFromCard}/>)
                       }


                    </div>
                    <button class="btn btn-primary btn-purchase" type="button" onClick={this.emptyShoppingCard}>
                        Empty Cart
                    </button>
                </section>
                <footer class="main-footer">
                    <div class="container main-footer-container">
                        ...
                        <ul class="nav footer-nav">
                            ...
                            {
                                this.state.shoppingCart.map(product=> <Social {...this.state.socials}/>)
                            }
                        </ul>
                    </div>
                </footer>
